...
def main():
    ...
    np.save(f'{tempFilePath}/train_losses', train_losses)
    np.save(f'{tempFilePath}/train_accuracies', train_accuracies)
    np.save(f'{tempFilePath}/validation_losses', validation_losses)
    np.save(f'{tempFilePath}/validation_accuracies', validation_accuracies)
    ...
    np.save(f'{tempFilePath}/x_embedded', x_embedded)
